...
The framework is implemented using a Car-3 differential-drive robotic platform integrated with ultrasonic sensors, Arduino-based embedded control, Bluetooth communication, and Android-supported edge-AI processing. Sponsored by ZAS Robotics
